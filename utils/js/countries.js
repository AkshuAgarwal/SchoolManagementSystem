export const countries = [
    ...
    { icon : 'ðŸ‡®ðŸ‡´', name : 'British Indian Ocean Territory', abbr : 'IO', code : '246' },
    ...
    { icon : 'ðŸ‡¨ðŸ‡©', name : 'Congo, Democratic Republic of the', abbr : 'CG', code : '243' },
    { icon : 'ðŸ‡¨ðŸ‡¬', name : 'Congo, Republic of the', abbr : 'CD', code : '242' },
    ...
    { icon : 'ðŸ‡»ðŸ‡¨', name : 'Saint Vincent and the Grenadines', abbr : 'VC', code : '1-784' },
