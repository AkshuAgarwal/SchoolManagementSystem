                    ...
                    <form onSubmit={handleSubmit}>
                        {
                            tabValue === 'search_by_username' ? (
                                <FormControl margin="normal" sx={{ width : '100%' }} required>
                                    <InputLabel htmlFor="__dashboard_admin__form_searchuser__username">Username</InputLabel>
                                    <OutlinedInput
                                        id="__dashboard_admin__form_searchuser__username"
                                        inputRef={searchRef}
                        ...
                        }
                        {
                            tabValue === 'search_by_email' ? (
                                <FormControl margin="normal" sx={{ width : '100%' }} required>
                                    <InputLabel htmlFor="__dashboard_admin__form_searchuser__email">Email ID</InputLabel>
                                    <OutlinedInput
                                        id="__dashboard_admin__form_searchuser__email"
                                        type="email"
                                        inputRef={searchRef}
                                        label="Email ID"
                                    />
                        ...
                        }
                        {
                            tabValue === 'search_by_id' ? (
                                <FormControl margin="normal" sx={{ width : '100%' }} required>
                                    <InputLabel htmlFor="__dashboard_admin__form_searchuser__id">ID</InputLabel>
                                    <OutlinedInput
                                        id="__dashboard_admin__form_searchuser__id"
                                        inputRef={searchRef}
