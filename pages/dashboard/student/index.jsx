...
export default function Student() {
        ...
        items: [
            {
                ...
                icon  : <FolderOpenIcon />,
                items : [
                    { type : 'listitem', id : 'view-assignments', text : 'View Assignments', pageComponent : <ViewAssignments /> },
                ],
            },
        ],
    ...
    useEffect(() => {
        if (authContext.documentLoaded) {
            if (rendering) {
                ...
                } else if (authContext.userData.user_type !== 's') {
    ...
    return (
        <>
            <Head>
                <title>Student Dashboard | {publicRuntimeConfig.SCHOOL_NAME}</title>
            </Head>
