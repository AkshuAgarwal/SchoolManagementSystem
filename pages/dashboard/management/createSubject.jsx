                ...
                <Container sx={{ marginTop : '30px', maxWidth : { xs : '90%', sm : '80%', md : '60%', lg : '45%' } }}>
                    ...
                    <form onSubmit={handleSubmit}>
                        <FormControl margin="normal" sx={{ width : '100%' }} required>
                            <InputLabel htmlFor="__dashboard_management__form_createsubject__name" error={existingSubjectError}>Name</InputLabel>
                            <OutlinedInput
                                id="__dashboard_management__form_createsubject__name"
                                aria-describedby="__dashboard_management__form_createsubject__name_helper"
                                label="Name"
                                inputRef={nameRef}
                                onChange={checkExistingSubject}
                                error={existingSubjectError}
                            />
                            <FormHelperText id="__dashboard_management__form_createsubject__name_helper" error={existingSubjectError}>
                                { existingSubjectError ? 'Subject already exists with the given name and code' : null }
                            </FormHelperText>
                        </FormControl>
                        <FormControl margin="normal" sx={{ width : '100%' }} required>
                            <InputLabel htmlFor="__dashboard_management__form_createsubject__code" error={existingSubjectError}>Code</InputLabel>
                            <OutlinedInput
                                id="__dashboard_management__form_createsubject__code"
                                aria-describedby="__dashboard_management__form_createsubject__code_helper"
                                type="number"
                                label="Code"
                                inputRef={codeRef}
                                onChange={checkExistingSubject}
                                error={existingSubjectError}
                            />
                            <FormHelperText id="__dashboard_management__form_createsubject__code_helper" error={existingSubjectError}>
                                { existingSubjectError ? 'Subject already exists with the given name and code' : null }
                            </FormHelperText>
                        </FormControl>
