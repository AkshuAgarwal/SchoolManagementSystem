    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('s', 'Student'), ('t', 'Teacher'), ('p', 'Parent'), ('m', 'Management')], help_text='Designation/Department/Type of user', max_length=2, verbose_name='User Type')),
                ...
                ('ip_address', models.GenericIPAddressField(help_text='IP Address from which the user last logged in', verbose_name='IP Address')),
