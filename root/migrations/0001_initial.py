# Generated by Django 3.2.9 on 2021-12-19 07:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.IntegerField(blank=True, null=True, verbose_name='Avatar ID')),
        ...
        migrations.CreateModel(
            name='Management',
            fields=[
                ('management', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='management', serialize=False, to='root.user')),
        ...
        migrations.CreateModel(
            name='Parent',
            fields=[
                ('parent', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='parent', serialize=False, to='root.user')),
            ],
        ),
        migrations.CreateModel(
            name='Teacher',
            fields=[
                ('teacher', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='teacher', serialize=False, to='root.user')),
                ('year_of_joining', models.IntegerField(verbose_name='Year of Joining')),
                ('salary', models.IntegerField(verbose_name='Salary')),
                ('classes', models.ManyToManyField(related_name='teacher_set', to='root.Class')),
                ('owns_class', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='teacher', to='root.class')),
                ('subject', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='teacher_set', to='root.subject')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ('student', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='student', serialize=False, to='root.user')),
                ...
                ('grade', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='student_set', to='root.class')),
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='student_set', to='root.parent')),
            ],
        ),
    ]
